...
`splitGraph` can derive direct constraints for subject, batch, study, time, and
site as well as composite constraints that combine multiple dependency sources.
